// This will serve the socket.io server that will service
// both node and react clients
...
// workers will do the socket.io handling.
...
if (cluster.isMaster) {
	...
	let spawn = function(i) {
		...
		// Optional: Restart worker on exit (This is listening to a worker death,an 'exit' event to run spawn and reconnect)
